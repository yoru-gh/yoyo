...
// tip
function tip(mes,time){var thisTime=time||2500;var as=null,bs=null;var oldobj=document.getElementById("tips");if(!(oldobj==null)){oldobj.parentNode.removeChild(oldobj)}var obj=document.createElement("div");obj.id="tips";obj.innerHTML=mes;document.body.appendChild(obj);as=setTimeout(function(){obj.classList.add("active")},50);bs=setTimeout(function(){if(obj.parentNode==null){return}obj.parentNode.removeChild(obj)},thisTime)};
// throttle
function throttle(fun,delay,time){var timeout,startTime=new Date();return function(){var context=this,args=arguments,curTime=new Date();clearTimeout(timeout);if(curTime-startTime>=time){fun.apply(context,args);startTime=curTime}else{timeout=setTimeout(fun,delay)}}};
// ajax
